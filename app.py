...
def build_prompt(name):
    return (
        ...
        f"A glowing 'DO' DigitalOcean logo emblem is prominently featured on the chest. "
        ...
        f"confident pose. "
        f"At the very bottom of the image is a sleek dark footer banner with white text reading: "
        f"'Built using DigitalOcean Serverless Inference at Cloudconf, Bangalore'. "
